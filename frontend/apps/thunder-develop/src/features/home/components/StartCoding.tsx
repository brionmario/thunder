...
import {Box, Stack, Button, Tooltip, Typography, Divider, IconButton, useColorScheme} from '@wso2/oxygen-ui';
import {FolderDown, ChevronLeft, ChevronRight} from '@wso2/oxygen-ui-icons-react';
...
export default function StartCoding(): JSX.Element {
  ...
  const handleFrameworkClick = (frameworkId: string) => {
    ...
    void navigate(`/applications/create?framework=${frameworkId}`);
  };
